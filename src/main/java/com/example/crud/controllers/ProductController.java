...
import com.example.crud.service.SearchCityByCepService;
...
public class ProductController {
    ...
    @Autowired
    public ProductController(ProductRepository repository, AddressSearch addressSearch, SearchCityByCepService searchCityByCepService) {
    ...
    @GetMapping("/produto/cep-compativel")
    public ResponseEntity<Boolean> SearchCityOfProductByCep(
            @RequestParam String id,
            @RequestParam String cep
    ) {
        Boolean resultado = searchCityByCepService.SearchCityOfProductByCep(id, cep);
